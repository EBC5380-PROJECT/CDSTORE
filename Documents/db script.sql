...
INSERT INTO CD (cdid, title, price, categoryId) VALUES ('cd001', 'Johnny Cash Greatest Hits', 1599, 1);
INSERT INTO CD (cdid, title, price, categoryId) VALUES ('cd002','Willy Nelson Greatest', 1599, 1);
INSERT INTO CD (cdid, title, price, categoryId) VALUES ('cd003','Patsy Cline Im So Lonely' ,1599,1);
INSERT INTO CD (cdid, title, price, categoryId) VALUES ('cd004', 'Tragically Hip Fully Completely', 2000, 2);
INSERT INTO CD (cdid, title, price, categoryId) VALUES ('cd005', 'Beatles White Album', 2000, 2);
INSERT INTO CD (cdid, title, price, categoryId) VALUES ('cd006', 'Rolling Stones Forty Licks', 2000, 2);
INSERT INTO CD (cdid, title, price, categoryId) VALUES ('cd007', 'Madonna Greatest Hits', 1799, 3);
INSERT INTO CD (cdid, title, price, categoryId) VALUES ('cd008', 'Alannis Morissette Jagged Little Pill', 1799, 3);
INSERT INTO CD (cdid, title, price, categoryId) VALUES ('cd009', 'Video Killed the Radio Star', 1799, 3);
#
#
...
CREATE TABLE Account (
 id 	varchar(20) not null REFERENCES CD.cdid,
