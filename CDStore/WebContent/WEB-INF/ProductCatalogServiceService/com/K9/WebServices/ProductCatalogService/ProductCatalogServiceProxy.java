...
public class ProductCatalogServiceProxy implements com.K9.WebServices.ProductCatalogService.ProductCatalogService {
  private String _endpoint = null;
  private com.K9.WebServices.ProductCatalogService.ProductCatalogService productCatalogService = null;
  ...
  private void _initProductCatalogServiceProxy() {
    try {
      productCatalogService = (new com.K9.WebServices.ProductCatalogService.ProductCatalogServiceServiceLocator()).getProductCatalogService();
  ...
  public com.K9.WebServices.ProductCatalogService.ProductCatalogService getProductCatalogService() {
    if (productCatalogService == null)
      _initProductCatalogServiceProxy();
