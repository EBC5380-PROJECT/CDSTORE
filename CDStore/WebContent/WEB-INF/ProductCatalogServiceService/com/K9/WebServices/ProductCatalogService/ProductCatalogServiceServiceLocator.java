...
public class ProductCatalogServiceServiceLocator extends org.apache.axis.client.Service implements com.K9.WebServices.ProductCatalogService.ProductCatalogServiceService {
    ...
    public com.K9.WebServices.ProductCatalogService.ProductCatalogService getProductCatalogService() throws javax.xml.rpc.ServiceException {
    ...
    public com.K9.WebServices.ProductCatalogService.ProductCatalogService getProductCatalogService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.K9.WebServices.ProductCatalogService.ProductCatalogServiceSoapBindingStub _stub = new com.K9.WebServices.ProductCatalogService.ProductCatalogServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.K9.WebServices.ProductCatalogService.ProductCatalogService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.K9.WebServices.ProductCatalogService.ProductCatalogServiceSoapBindingStub _stub = new com.K9.WebServices.ProductCatalogService.ProductCatalogServiceSoapBindingStub(new java.net.URL(ProductCatalogService_address), this);
                _stub.setPortName(getProductCatalogServiceWSDDServiceName());
                return _stub;
            }
        }
